...
const upper = runners.map(function(runners) {
...
const largeRunners = runners.filter(function(runners) {
...
const taxesSum = runners.reduce(function(total, donation) {
  ticketPriceTotal.push(total + donation);
}, 0);
